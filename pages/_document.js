...
const appSettings = {
  name: 'The Crowd Round',
  url: 'crowdround.kielbyrne.com',
  imageUrl: '',
  twitter_handle: 'thecrowdround',
  description: 'Helping women/latinx/black/youth entrepreneurs with existing businesses gain access to crowdfunding capital and mentorship/coaching to meet short-term business goals',
...
class MyDocument extends Document {
	render() {
		return (
          ...
          <link rel='mask-icon' href='/static/img/safari-pinned-tab.svg' color={theme.palette.primary.main} />
